...
const EditProduct = ({ onclose, Aprouct }) => {
  const [Product, setProduct] = useState({
    _id: Aprouct._id,
    createdAt: Aprouct.createdAt,
    productName: Aprouct.productName,
    description: Aprouct.description,
    category: Aprouct.category,
    price: Aprouct.price,
    quantity: Aprouct.quantity,
    image: Aprouct.image,
    brand: Aprouct.brand,
    sellingPrice: Aprouct.sellingPrice,
  });
  // console.log(Aprouct);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const res = await api.post(
        `/product/edit-product/${Product._id}`,
        Product
      );
      if (res) {
        onclose();
